              ...
              : !gpsIsReady
                  ...
                  : Column(
                      children: [
                        ...
                        if (!rideIsStarted)
                          const Text('GPS prêt', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.teal))
                        else if (safetyShareCode != null)
                          Text(safetyUrl!, style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.teal)),
